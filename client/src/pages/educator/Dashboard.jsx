...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screem flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div>
          ...
          <div className='flex flex-col items-centermax-w-4xl w-full overflow-hidden rouded-md bg-white border border-gray-500/20'>
